[WIP] This is an embedded c++ project template based on Jason Turner template. 
Why? I've been using the template for some time and got tired of repeating the same tasks...  

# cpp_starter_project

![CMake](https://github.com/euripedesrocha/embedded_cpp_starter_project/workflows/CMake/badge.svg)

## Getting Started

### Use the Github template
First, click the green `Use this template` button near the top of this page.
This will take you to Github's ['Generate Repository'](https://github.com/euripedesrocha/embedded_cpp_starter_project/generate) page. 
